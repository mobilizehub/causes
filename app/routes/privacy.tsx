...
function PrivacyPolicy() {
    return (
        <div className="mt-16 prose prose-sm prose-slate">
            <h2>1. INTRODUCTION</h2>

            <p>
                Welcome to {constants.organizationName}{" "}
                ...
                website, mobile applications, and other platforms (collectively,
                the "Services").
            </p>
            ...
            <p>
                Third parties that help us deliver our Services (payment
                processors, hosting providers, email services).
            </p>

            <h3>4.2 Partner Organizations</h3>
            <p>
                With your consent, we may share information with other
            ...
            <p>
                You can manage cookies through your browser settings and our
            ...
            <p>
                ...
                located outside your country of residence, including in the
            ...
            <p>
                ...
                to review this Privacy Policy regularly to stay informed of how
            ...
            <p>
                ...
                shall be resolved in accordance with our Terms of Service.
            </p>
